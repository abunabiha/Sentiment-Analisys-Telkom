# -*- coding: utf-8 -*-
"""BPML-Mid-Submission-1.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1t924p-AQFIGUNxbzvBDS1px7rSO8AN7d
"""
...
# Input layer with 200 input features, first hidden layer with 128 neurons and ReLU activation
...
Y_binary = np.where(y_train == 'positive', 1, 0)
...
true_binary = np.where(y_test == 'positive', 1, 0)

from sklearn.metrics import confusion_matrix, classification_report
print('\n Classification Report')
print(classification_report(true_binary, predictions_binary, target_names=["Negative","Positive"]))